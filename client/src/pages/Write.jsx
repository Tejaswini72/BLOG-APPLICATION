  ...
  const handleClick = async (e) => {
    ...
    return (
      <div className="add">
        ...
        <div className="menu">
          <div className="item">
            <input style = {{display : "none"}} type = "file" id='file' name = '' onChange={(e) => setFile(e.target.files[0])}></input>
          ...
          <div className="item">
            ...
            <div className="cat">
              <input type = "radio" name = "cat" value = "tech" id = "tech" onChange={(e) => setCat(e.target.value)}/>
